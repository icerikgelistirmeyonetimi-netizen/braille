import {
  ...
  muzikSureBeatAl,
} from '../src/utils/music-brf/musicPlaybackHelpers.js';
...
// B) sus bekleme: event süre + play false
const susEtkinlikleri = muzikPlaybackEventListesiOlustur({
  ogeler: [{ id: 'R1', tip: 'sus', sureIndeksi: 1 }], // dörtlük sus
  baglar: [],
  muzikHeader: {},
});
...
// C) durationBeats öncelikli (oge dörtlük olsa da event beats kazanır)
...
// D) tie: iki dörtlük birleşimi 2 beat
