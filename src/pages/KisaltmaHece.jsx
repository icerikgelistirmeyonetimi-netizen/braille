...
export default function KisaltmaHece() {
  ...
  return (
    <div className="page">
      ...
      <div className="controls">
        <button className="btn" type="button" aria-label="Tekrar dinle" onClick={() => konus(`${k.hece} hecesi.`, { kesintiyle: true })}>
        ...
        <button className="btn" type="button" aria-label="Anladım, sonraki" onClick={() => { basariBildir('Sıradaki hece.'); setTimeout(() => setIndeks((i) => i + 1), 600); }}>
