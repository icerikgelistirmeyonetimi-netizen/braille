...
export default function KisaltmaKelimeParcasi() {
  ...
  return (
    <div className="page">
      ...
      <div className="page-mid">
        <div className="ders-eylem-satiri">
          ...
          <button
            ...
            className={`btn sonra-kaydet-btn sayfa-ici${kaydedildi ? ' kaydedildi' : ''}`}
            onClick={kaydetSonra}
          >
      ...
      <div className="controls">
        <button className="btn" type="button" aria-label="Tekrar dinle" onClick={() => konus(`${k.etiket}, ${k.ekler}.`, { kesintiyle: true })}>
        ...
        <button className="btn" type="button" aria-label="Önceki" disabled={indeks === 0} onClick={() => setIndeks((i) => Math.max(0, i - 1))}>
        ...
        <button className="btn" type="button" aria-label="Anladım, sonraki" onClick={() => { basariBildir('Sıradaki kısaltma.'); setTimeout(() => setIndeks((i) => i + 1), 600); }}>
